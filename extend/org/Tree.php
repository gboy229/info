...
class tree {
	...
	*/
	 ...
	 */
    function get_treeview($myid,$effected_id='example',$str="<span class='file'>\$name</span>", $str2="<span class='folder'>\$name</span>" ,$showlevel = 0 ,$style='lightTreeview' , $currentlevel = 1,$recursion=FALSE) {
        $child = $this->get_child($myid);
